-- Get Unreleased Leaks/Sources/ Or For Skidding Join KnoxSkid(We make ,We Leak)
-- https://discord.gg/dxdxZzyfmx
...
local win = library.new({
    Name = "https://discord.gg/dxdxZzyfmx",
...
local function resetMiniButtonPositions()
    ...
    win:Notify({
        ...
        Content = "Trun Off save cofing,Click ResetMiniBtn,Rejoin.",
        Duration = 5
    })
end
